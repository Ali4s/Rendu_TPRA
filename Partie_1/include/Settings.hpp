//
// Created by seymour on 10/01/18.
//

#ifndef TERA_SETTINGS_HPP
#define TERA_SETTINGS_HPP
#include "opencv.hpp"
...
public:
    ...
    static bool isListOfImages( const  std::string& filename)
    {
        ...
        if( s.find(".xml") ==  std::string::npos && s.find(".yaml") ==  std::string::npos && s.find(".yml") == string::npos )
            return false;
        else
            return true;
    }
